...
class ApplicationMain
{
	...
	{
		#if openfl
		flash.Lib.setPackage("HaxeFlixel", "intergalactic", "com.example.myapp", "0.0.1");
		...
		wx.App.boot(function()
		{
			...
			frame = wx.Frame.create(null, null, "intergalactic", null, { width: 640, height: 640 });
			
			#if openfl
			var stage = wx.NMEStage.create(frame, null, null, { width: 640, height: 640 });
			#end
